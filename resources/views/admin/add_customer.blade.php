     ...
     <div class="row align-items-center">
         ...
         <div class="col-sm-6">
            <div class="float-end d-none d-sm-block">
                <a href="{{ route('customer') }}" class="btn btn-success">All Customer</a>
            </div>
         </div>
     </div>
    </div>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="row mt-2">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="header-title">Add Customer </h2>
                        
                        <form action="{{ route('store.customer') }}" method="post" class="needs-validation mt-2" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
