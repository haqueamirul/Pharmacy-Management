        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div>
                            <a href="{{ route('add.customer') }}" class="btn btn-success mb-2"><i class="mdi mdi-plus me-2"></i> Add Customer</a>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($customers as $customer)
                                        <tr>
                                            ...
                                            <td>
                                                BDT {{ $customer->pre_balace }}
                                            </td>
                                            <td>
                                                {{ $customer->created_at }}
                                            </td>
                                            <td id="tooltip-container0">
                                                <a href="{{ url('/edit-customer') }}-{{ $customer->id }}" class="me-3 text-primary" data-bs-container="#tooltip-container0" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
